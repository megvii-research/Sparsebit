...
_C.A.QUANTIZER.TRAINING.LR = 4.0e-2
_C.A.QUANTIZER.TRAINING.ITERS = 5000
_C.A.QUANTIZER.PACT = CN()
_C.A.QUANTIZER.PACT.ALPHA_VALUE = 10
_C.A.QUANTIZER.QUADAPTER = CN()
_C.A.QUANTIZER.QUADAPTER.GRANULARITY = "layerwise"  # layerwise/blockwise
_C.A.QUANTIZER.QUADAPTER.KEEP_GPU = False
_C.A.OBSERVER = CN()
