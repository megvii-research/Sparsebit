...
## News
- 2023.04.27: :fire: Pipeline parallelism is supported for [alpaca-qlora](https://github.com/megvii-research/Sparsebit/blob/main/large_language_models/alpaca-qlora) which enables fine-tuning llama-65b with 8*2080ti.
