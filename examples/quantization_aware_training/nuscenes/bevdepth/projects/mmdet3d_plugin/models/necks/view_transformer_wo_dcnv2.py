...
class ViewTransformerLSSBEVDepthWithoutDCNv2(ViewTransformerLiftSplatShoot):
    def __init__(self, extra_depth_net, loss_depth_weight, se_config=dict(), **kwargs):
        super(ViewTransformerLSSBEVDepthWithoutDCNv2, self).__init__(**kwargs)
        ...
        self.depthnet = nn.Conv2d(extra_depth_net['num_channels'][0],
                                  ...
                                  kernel_size=1,
                                  padding=0)
        self.dcn = nn.Sequential(*[nn.Conv2d(
