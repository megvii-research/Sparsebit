...
def get_args_parser():
    ...
    parser.add_argument('--qconfig', type=str, help="the config yaml of quantization")
    ...
    parser.add_argument('--pretrained', default='', help='the path of a pretrined model')
...
def main(args):
    ...
    if args.pretrained:
        if args.pretrained.startswith('https'):
            checkpoint = torch.hub.load_state_dict_from_url(args.pretrained, map_location='cpu', check_hash=True)
        else:
